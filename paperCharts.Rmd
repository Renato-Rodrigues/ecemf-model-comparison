---
title: "ECEMF model comparison"
author:
  - Rodrigues, Renato - Postdam Institute for Climate Impact Research
  - Pietzcker, Robert - Postdam Institute for Climate Impact Research
output:
  html_document:
    theme: paper
    toc: true
...
```{r Setting default chunk options, echo=FALSE, include = FALSE}
...
```{r loading_packages, echo=FALSE, include = FALSE}
  ...
  packagesList <- c("tidyr", "dplyr", "ggplot2", "grid", "gridExtra", "ggh4x", "ggrepel")
...
```{r create_charts, echo=FALSE, include=FALSE}
  ...
  # output folder
  dir.create(paste0("./output/svg"), recursive = TRUE, showWarnings = FALSE)
  dir.create(paste0("./output/png"), recursive = TRUE, showWarnings = FALSE)
...
dir.create("./output/svg", showWarnings = FALSE, recursive = TRUE)
...
ggsave("./output/png/Figure 1 Emissions panel.png", g[["Figure 1"]], device="png", width = 12, height = 10, dpi=300, units = "in")
ggsave("./output/svg/Figure 1 Emissions panel.svg", g[["Figure 1"]], device="svg", width = 12, height = 10, dpi=100, units = "in")
...
ggsave("./output/png/Figure 2. Electricity Generation from Wind and Solar and Share in electricity generation.png", g[["Figure 2"]], device="png", width = 12, height = 6, dpi=300, units = "in")
ggsave("./output/svg/Figure 2. Electricity Generation from Wind and Solar and Share in electricity generation.svg", g[["Figure 2"]], device="svg", width = 12, height = 6, dpi=100, units = "in")
...
decade_change <- plotData %>% 
 ...
 ggsave("./output/png/Figure 3. Share of electricity and hydrogen in final energy.png", g[["Figure 3"]], device="png", width = 12, height = 6, dpi=300, units = "in")
 ggsave("./output/svg/Figure 3. Share of electricity and hydrogen in final energy.svg", g[["Figure 3"]], device="svg", width = 12, height = 6, dpi=100, units = "in")
...
ggsave("./output/png/Figure 4. Carbon-containing final energy and energy imports.png", g[["Figure 4"]], device="png", width = 12, height = 8, dpi=300, units = "in")
ggsave("./output/svg/Figure 4. Carbon-containing final energy and energy imports.svg", g[["Figure 4"]], device="svg", width = 12, height = 8, dpi=100, units = "in")
...
```{r Emissions per sector, echo=FALSE, include=FALSE}
  ...
  totalHistVars <- c(
    "Total net Kyoto gases"                             = "Emi|GHG|w/ Bunkers"
    )
...
ggsave("./output/png/Figure 5. Emissions per sector and carbon capture scale-up.png", g[["Figure 5"]], device="png", width = 12, height = 10, dpi=300, units = "in")
ggsave("./output/svg/Figure 5. Emissions per sector and carbon capture scale-up.svg", g[["Figure 5"]], device="svg", width = 12, height = 10, dpi=100, units = "in")
...
ggsave("./output/png/Figure 6 Carbon price and Mitigation costs.png", g[["Figure 6"]], device="png", width = 12, height = 6, dpi=300, units = "in")
ggsave("./output/svg/Figure 6 Carbon price and Mitigation costs.svg", g[["Figure 6"]], device="svg", width = 12, height = 6, dpi=100, units = "in")
